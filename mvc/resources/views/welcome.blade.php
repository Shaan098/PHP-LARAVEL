...
<body class="bg-linear-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950 text-slate-900 dark:text-slate-100">
    <!-- Navigation -->
    ...
    <!-- CTA Section -->
    <section class="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="max-w-2xl mx-auto bg-linear-to-r from-slate-900 to-slate-800 dark:from-white dark:to-slate-100 rounded-3xl p-12 md:p-16 text-center">
