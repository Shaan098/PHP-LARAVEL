...
<div class="max-w-md mx-auto mt-12 p-6 bg-white dark:bg-slate-800 rounded-lg shadow">
    <h2 class="text-2xl font-bold mb-6 text-slate-900 dark:text-white">Create Account</h2>
    ...
    <form method="POST" action="#">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="name" name="name" required class="w-full px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-slate-500">
        </div>
    ...
    <p class="mt-4 text-center text-slate-600 dark:text-slate-400">
        Already have an account? <a href="{{ route('login') }}" class="text-slate-900 dark:text-white font-semibold hover:underline">Sign in here</a>
    </p>
</div>
@endsection
