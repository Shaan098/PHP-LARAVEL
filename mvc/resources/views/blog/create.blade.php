...
<div class="container mx-auto px-4 py-12">
    <div class="max-w-3xl mx-auto animate-fade-in-up">
        <div class="mb-8">
            <a href="{{ route('blog.index') }}" class="inline-flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-semibold transition-colors mb-6">
                ← Back to Blog
            </a>
            <h1 class="text-5xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">
                ✍️ Create New Post
            </h1>
            <p class="text-gray-600 dark:text-gray-400 text-lg">Share your story with the world</p>
        </div>

        <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data" class="bg-white dark:bg-slate-900 p-8 rounded-xl shadow-lg dark:shadow-2xl space-y-6">
            @csrf
